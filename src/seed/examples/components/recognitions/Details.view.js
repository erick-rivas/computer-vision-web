...
const RecognitionDetailsView = ({ recognition, onClickDelete }) =>
  <div class="card">
    ...
    <div class="card-footer">
      <div class="d-flex justify-content-end">
        <Link to={`/${recognition.id}/edit`} class="btn btn-secondary mr-2">Edit recognition</Link>
        <button class="btn btn-danger" onClick={onClickDelete}>Delete recognition</button>
      </div>
    </div>
  </div>;

RecognitionDetailsView.propTypes = {
  recognition: PropTypes.object.isRequired,
  onClickDelete: PropTypes.func
};

export default RecognitionDetailsView;